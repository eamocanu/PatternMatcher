...
import brain.model.NeuronBank;

public class BrainUi extends JFrame {
	...
	public BrainUi() {
		...
		neuronsPanel.setLayout(new GridLayout(5, 5, 0, 0)/*new BoxLayout(neuronsPanel, BoxLayout.Y_AXIS)*/);
	...
	NeuronBank brain;
	public void setBrain(NeuronBank nb){
		this.brain=nb;
	}
